...
public class AnimationUtils {
     ...
     * @param delayMillis :
     */
    public static void startAnimation(View view, int resId, Runnable r, long delayMillis) {
        Animation animation = android.view.animation.AnimationUtils.loadAnimation(App.getAppContext(), resId);
        view.startAnimation(animation);
        // 执行其他事件
        if (null != r) {
    ...
    public static void startViewImageAnim(final View view) {
        ...
        if (null != drawable) {
            ...
            ValueAnimator squashAnimSize = ObjectAnimator.ofInt(5);
...
//			}
     ...
     * @param targetValue
     */
    public static void startIntValueAnim(final TextView view, final int res, final int value, int targetValue, long duration) {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (-1 == res) {
                    ...
                    view.setText(App.getStr(res, value));
                }
            }
        });
        valueAnimator.start();
